...
\begin{beamercolorbox}[wd=\paperwidth,
					   ht=\dimexpr\fau@outer@logoraum+\fau@outer@linienstaerke, dp=0ex]{headline}
\vbox to\fau@outer@logoraum{%
\iffau@isuserlogo
	\vskip\fau@outer@standy
	\hskip\dimexpr\fau@outer@urlraum+\fau@outer@linienstaerke
	\begin{beamercolorbox}[wd=\fau@outer@userlogobreite,
						   ht=\fau@outer@logohoehe,dp=0ex]{headline userlogo}%
	...
	\end{beamercolorbox}%
	\hskip\dimexpr\fau@outer@standx-\fau@outer@userlogobreite-
				  \fau@outer@urlraum-\fau@outer@linienstaerke%
\else
	\vskip\fau@outer@standy
...
\begin{beamercolorbox}[wd=\dimexpr\paperwidth-\fau@outer@absenderraum-
								  \fau@outer@linienstaerke+\fau@outer@outlinestaerke,
...
\begin{beamercolorbox}[wd=\dimexpr\fau@outer@absenderraum+
						  \fau@outer@linienstaerke-\fau@outer@outlinestaerke]{sidebar}
\vskip\fau@outer@absenderskip
\vbox to\dimexpr2\fau@outer@absenderhoehe+\fau@outer@linienstaerke{%
\begin{beamercolorbox}[wd=\fau@outer@absenderraum,ht=\fau@outer@absenderhoehe,dp=0pt]{sidebar top}
\end{beamercolorbox}%
\nointerlineskip%
...
\iffau@isfau
	...
	\end{tikzpicture}
\else
	\begin{beamercolorbox}[wd=\fau@outer@absenderraum,ht=\fau@outer@absenderhoehe,dp=0pt]{sidebar bot}
	\end{beamercolorbox}%
\fi
}%
\vskip\dimexpr\paperheight-\fau@outer@logoraum-
	   \fau@outer@absenderskip-\fau@outer@urlraum-2\fau@outer@absenderhoehe
\end{beamercolorbox}%
...
\begin{beamercolorbox}[wd=\dimexpr\paperwidth-\fau@outer@absenderraum-
  						  \fau@outer@linienstaerke+\fau@outer@outlinestaerke, 
  						  ht=\fau@outer@outlinestaerke, right]{outline}
\end{beamercolorbox}
%
\begin{beamercolorbox}[wd=\paperwidth,ht=\dimexpr\fau@outer@urlraum-2mm, dp=2mm]{footline}
